...
export default function Index ({ archiveUrl, thoughts }) {
  return (
    <Page title='Styleguide'>
      ...
      <main>
        <h1>Styleguide</h1>
        <p>An almost comprehensive example of styles. (It's not that comprehensive.)</p>
        ...
        <div className='example'>
          <div className='example-demo'>
            <p>This is a <strong>strong</strong> paragraph with <em>emphasis</em> on features of CSS <code>code</code>.</p>
          </div>
        ...
        <div className='example'>
          ...
          <pre className='example-code'>
            <div>&lt;h1&gt;&lt;a href="#"&gt;Link to nowhere&lt;/a&gt;&lt;/h1&gt;</div>
            <div>&lt;h2&gt;&lt;a href="#"&gt;Link to nowhere&lt;/a&gt;&lt;/h2&gt;</div>
            <div>&lt;h3&gt;&lt;a href="#"&gt;Link to nowhere&lt;/a&gt;&lt;/h3&gt;</div>
            <div>&lt;h4&gt;&lt;a href="#"&gt;Link to nowhere&lt;/a&gt;&lt;/h4&gt;</div>
